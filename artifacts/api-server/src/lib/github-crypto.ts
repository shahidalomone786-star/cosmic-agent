...
export function encryptGitHubToken(token: string): { encryptedToken: string; nonce: string; authTag: string } {
...
export function decryptGitHubToken(encryptedToken: string, nonce: string, authTag: string): string {
